...
[![Release](https://img.shields.io/github/v/release/pecefulpro/1.4-Training-Mod?style=flat-square)](https://github.com/pecefulpro/1.4-Training-Mod/releases/latest)
[![Platform](https://img.shields.io/badge/platform-Windows-blue?style=flat-square)](#installation)
[![Status](https://img.shields.io/badge/status-Beta-orange?style=flat-square)](#about-the-project)
...
* **Tower of Salvation**
  ...
  * Custom dynamic music track when active.
  ...
  ![Tower of Salvation Alt Skin](./photos/TOS.png)

* **Battlefield**
  * Alternate skin: *Night Battlefield*
  * Custom dynamic music track when active.

  ![Night Battlefield Alt Skin](./photos/nightly-battlefield.png)
...
<details>
<summary><b>4. Is there Linux or macOS support?</b></summary>
<br>
